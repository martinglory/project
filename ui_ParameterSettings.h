...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        verticalLayout_4->addWidget(checkBox_14);
    ...
    {
        Form->setWindowTitle(QApplication::translate("Form", "ParameterSettings", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("Form", "A", 0, QApplication::UnicodeUTF8));
