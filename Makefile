#############################################################################
# Makefile for building: library.app/Contents/MacOS/library
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Mar 11 18:28:31 2015
# Project:  library.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile library.pro
#############################################################################
...
DESTDIR       = 
TARGET        = library.app/Contents/MacOS/library
...
all: Makefile library.app/Contents/PkgInfo library.app/Contents/Resources/empty.lproj library.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) library.app/Contents/MacOS/ || $(MKDIR) library.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: library.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
...
library.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) library.app/Contents || $(MKDIR) library.app/Contents 
	@$(DEL_FILE) library.app/Contents/PkgInfo
	@echo "APPL????" >library.app/Contents/PkgInfo
library.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) library.app/Contents/Resources || $(MKDIR) library.app/Contents/Resources 
	@touch library.app/Contents/Resources/empty.lproj
	
library.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) library.app/Contents || $(MKDIR) library.app/Contents 
	@$(DEL_FILE) library.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,library,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >library.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/library1.0.0 || $(MKDIR) .tmp/library1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/library1.0.0/ && $(COPY_FILE) --parents library.hpp .tmp/library1.0.0/ && $(COPY_FILE) --parents library.cpp main.cpp .tmp/library1.0.0/ && (cd `dirname .tmp/library1.0.0` && $(TAR) library1.0.0.tar library1.0.0 && $(COMPRESS) library1.0.0.tar) && $(MOVE) `dirname .tmp/library1.0.0`/library1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/library1.0.0
